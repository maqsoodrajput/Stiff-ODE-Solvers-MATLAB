function [T,Y,ISTATUS]=...
    BE(Function,Tspan,Y0,Options)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
global rkS rkGamma rkC rkB rkA rkD
...
for istage=1:rkS
  ...
  for	NewtonIter=0:NewtonMaxit-1
   ...
   if(NewtonIter==0)
    ...
    %NewtonDone=(norm(NewtonIncrement));
    if(NewtonDone == 1)
     %disp('Newton Done!')
     %disp('Z')
     %disp(Z)
...
%/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
global ZERO ONE 
global  BEL  sdMethod rkS rkGamma rkA rkB rkC rkD
