function [T, Y,T_full,Y_full, T_rej,Y_rej ,RCNTRL, ICNTRL, RSTAT, ISTAT] = ...
    Rosenbrock_test(Function, Tspan, Y0, Options, RCNTRL, ICNTRL)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
for i=2:steps
    [T(i), Y(i,:),T_full,Y_full,T_rej,Y_rej, IERR,ISTATUS,RSTATUS] = ...
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
function [ T, Y,T_full,Y_full,T_rej,Y_rej, IERR,ISTATUS,RSTATUS ] = RosenbrockIntegrator(N, Y, Tstart, Tend, ...
...
while ( (Direction > 0) && ((T-Tend)+Roundoff <= ZERO) || ...
	...
	%Fac  = max(FacMin,FacSafe/(Err^(ONE/ros_ELO)));
