function [T, Y,T_full,Y_full, RCNTRL, ICNTRL, RSTAT, ISTAT] = ...
...
Y_full = [Y0]
for i=2:steps
    [T(i), Y(i,:),T_full,Y_full, IERR] = ...
        RosenbrockIntegrator(N, Y(i-1,:), T(i-1),Tspan(i), ...
            Function, Jacobian, ATOL, RTOL, RCNTRL, ICNTRL,T_full,Y_full);
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
function [ T, Y,T_full,Y_full, IERR ] = RosenbrockIntegrator(N, Y, Tstart, Tend, ...
    OdeFunction, OdeJacobian, AbsTol, RelTol, RCNTRL, ICNTRL,T_full,Y_full)
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
